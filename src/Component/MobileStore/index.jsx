  ...
  <div className="wrap-dis-85 wrap-tab-11 wrap-mob-11 margin-bottom-13">
    ...
    <div className="fl-dis-left fl-tab-left banner-element-first">
      <h2 className="abhaya extra-bold">
        Download Property Turkey <br /> Mobile Application
      </h2>
    </div>
      ...
      <div className="app-icons">
        ...
        >
          <img
            ...
            src="https://www.propertyturkey.com/front/image/app-store.png"
          />
        </a>
        <a
        ...
        >
          <img
            ...
            src="https://www.propertyturkey.com/front/image/play-store.png"
          />
        </a>
      </div>
    </div>
