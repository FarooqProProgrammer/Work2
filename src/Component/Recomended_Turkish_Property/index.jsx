...
export default function Recomended_Turkish_Property() {
    ...
    return (
        <>
            <Box className="hot-properties-bg">
                <section
                    id="hot-properties"
                ...
                >
                    ...
                    <Box className="section--filter-wrapper">
                        <ul className="popular-cities section--filter" style={{}}>
                            ...
                            <li>
                                <Link className="btn section--filter-link" rel="Istanbul">
                                    Istanbul
                                </Link>
                            </li>
                            <li>
                                <Link className="btn section--filter-link" rel="Bodrum">
                                    Bodrum
                                </Link>
                            </li>
                            <li>
                                <Link className="btn section--filter-link" rel="Antalya">
                                    Antalya
                                </Link>
                            </li>
                        </ul>
