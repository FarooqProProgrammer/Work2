  ...
  >
    <div className="wrap-dis-9 wrap-tab-9 wrap-mob-9 clearfix flex items-center">
      ...
      >
        ...
        <meta
          itemProp="item"
          content="https://www.propertyturkey.com/about-turkey"
        />
      ...
      <div className="col-12  col-md-9  buyer-guide--side-bar-bg-details">
        <div className="container-fluid">
          ...
          <div className="buyer-guide--side-bar-bg-details--dates">
            <span>Updated: </span> 13 April 2021
            <span className="margin-left-1">Created: </span> 14 May 2013
          </div>
          <article className="page-content">
            <div className="areabody clearfix" itemProp="articleBody">
              ...
              <p>
                ...
                >
                  <iframe
                    src="https://www.youtube.com/embed/zWawsDMOYLI"
              ...
              <h2>
                <span style={{ fontSize: 14 }}>
                  <strong style={{ fontSize: 14, lineHeight: "1.2em" }}>
              ...
              <p>
                <img
                  alt="Ottoman Empire map"
                  className="pyro-image alignment-left fr-fil fr-dii fr-draggable"
                  data-pyroimage="true"
                  dir="ltr"
                  id="The Ottoman Empire Map 17 Century"
                  src="/files/thumb/d5fe81552235204/399"
                  style={{ lineHeight: "1.2em", width: 1200 }}
              ...
              <div>
                ...
                connected to major river systems. <br />
                <br />• &nbsp; &nbsp;Total Area: 783, 562 square km <br />•
                &nbsp; &nbsp;Climate: Dry and hot summers and mild winters{" "}
                <br />• &nbsp; &nbsp;Highest Point: Mount Ararat 5,166 m <br />•
              ...
              <p>
                <br />
                <img
                  alt="Unbelievable facts about Turkey"
                  className="pyro-image alignment-none fr-dii fr-draggable"
                  data-pyroimage="true"
                  src="/files/thumb/19-facts-about-turkey.png/708"
                  style={{ width: 1200 }}
